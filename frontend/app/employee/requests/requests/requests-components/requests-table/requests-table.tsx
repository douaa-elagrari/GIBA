...
type RequestRow = { request: BaseRequest; details: Record<string, any> };
...
export default function RequestsTable() {
  ...
  const filtered = rows.filter(({ request }) => {
    ...
    const matchSearch =
      ...
      String(request.userId).includes(search);
        ...
        <div className="rm-search-wrap">
          ...
          <input
            ...
            placeholder={
              ...
              "Search by employee or request type..."
            }
          />
        </div>
                      ...
                      <td>
                        <div className="rm-emp-cell">
                          <div
                            className="rm-avatar"
                            style={{
                              background: avatarColor(String(request.userId)),
                            }}
                          >
                            {getInitials(`EMP ${request.userId}`)}
                          </div>
                          <p className="rm-emp-name">#{request.userId}</p>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <div className="rm-actions">
                          <button
                            ...
                            title="View"
                            onClick={() =>
                              router.push(`/hr/requests/${request.id}`)
                            }
                          >
                            <Eye size={15} />
                          </button>
                          ...
                          <button
                            ...
                            title="Comment"
                            onClick={() => setCommentModal(request.id)}
                          >
